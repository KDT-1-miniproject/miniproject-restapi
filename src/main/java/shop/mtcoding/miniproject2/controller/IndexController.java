...
public class IndexController {
    ...
    public @ResponseBody ResponseEntity<?> companyJoin(@RequestBody JoinCompanyReqDto joinCompanyReqDto) {
    ...
    public @ResponseBody ResponseEntity<?> personJoin(@RequestBody JoinPersonReqDto joinPersonReqDto) {
